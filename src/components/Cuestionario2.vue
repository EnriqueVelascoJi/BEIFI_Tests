    ...
    <div id="cuestionario_1">
        <div class="main_content container" id="curso">
            ...
            <form class="row g-3" @submit.prevent="guardarRespuestas">
                <div class="col-md-6">
                    <p>1. ¿Consideras que los campos eléctricos son reales, en el mismo sentido que los objetos físicos?</p>
                ...
                <div class="col-md-6 d-flex flex-column justify-content-between">
                    <p>2. ¿Un campo eléctrico, está en el tiempo?</p>
                    <div class="form-floating">
                ...
                <div class="col-md-6">
                    <p>3. ¿Un campo eléctrico, encarna algo en la realidad material?</p>
                    <div class="form-floating">
                ...
                <div class="col-md-6">
                    <p>4. Los campos eléctricos, ¿son objetos físicos?</p>
                    <div class="form-floating">
                ...
                <div class="col-md-6">
                    <p>5. ¿Consideras que la representación matemática de un objeto físico define la naturaleza de este último? </p>
                    <div class="form-floating">
                ...
                <div class="col-md-6">
                    <p>6. ¿Crees que, para conceptualizar una entidad física, sólo puede hacerse mediante una representación matemática?</p>
                    <div class="form-floating">
